function buildTable(){
    ...
    addLineToHTMLTable("Steve", "Nash");
    addLineToHTMLTable("Stephen", "Curry");
    addLineToHTMLTable("Xavi", "Celades");
}

function addLineToHTMLTable(fitstName, lastName){
    var tableBody = document.querySelector("#tableContactBody");

    var newRow = tableBody.insertRow();

    var firstNameCell = newRow.insertCell();
    firstNameCell.innerHTML = fitstName;
