...
function search() {
    var VideogameName = document.querySelector("#VideogameName").value;
    console.log(VideogameName);
    
    
    // API for getting info about an artist/band by name
    var url = encodeURI("https://www.ign.com/articles/the-game-awards-2021-winners-revealed" + VideogameName);
